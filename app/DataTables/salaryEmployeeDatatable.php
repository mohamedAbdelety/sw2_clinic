...
use Auth;
class salaryEmployeeDatatable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return datatables($query)
            ->addColumn('action', 'dashboard.fr.salary.buttons.employee.btn')
            ->addColumn('payablemonthes', 'dashboard.fr.salary.buttons.employee.payablemonthes')
            ->addColumn('payablesalary', 'dashboard.fr.salary.buttons.employee.payablesalary')
    ...
    {
        return 'Employee_Salary_' . date('YmdHis');
    }
}
