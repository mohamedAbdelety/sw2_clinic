...
class HRDatatable extends DataTable
{
    ...
    public static function lang(){
        $langJson = [
            ...
            "sLengthMenu" => trans('admin.select_menu_statment_hr'),
            "sZeroRecords" => trans('admin.no_result_hr'),
            "sEmptyTable" => trans('admin.no_data_hr'),
            "sInfo" => trans('admin.end_state_hr'),
            "sInfoEmpty" => trans('admin.end_state_empty_hr'),
            "sInfoFiltered" => "",
            "sInfoPostFix" => "",
        ...
        return $this->builder()
                    ...
                    ->parameters([
                        ...
                        'buttons' => [//'csv', 'excel', 'pdf', 'print', 'reset', 'reload'
                            ...
                            ['className'=>'btn btn-success datatables_btn','text'=>'<i class="fa fa-plus" style="margin-right:4px"></i> '.trans('admin.create_hr_button'),"action" => "function(){
