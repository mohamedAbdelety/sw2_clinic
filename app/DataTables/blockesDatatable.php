...
class blockesDatatable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables($query)
            ->addColumn('action', 'dashboard.admin.blockers.btn')
            ->addColumn('type', 'dashboard.admin.blockers.type')
    ...
    {
        return DB::table('staff')->where('block', '1')->get();
    ...
    public static function lang(){
        $langJson = [
           "sProcessing" => trans('admin.processing'),
            "sLengthMenu" => trans('admin.select_menu_statment_blocker'),
            "sZeroRecords" => trans('admin.no_result_blocker'),
            "sEmptyTable" => trans('admin.no_data_blocker'),
            "sInfo" => trans('admin.end_state_blocker'),
            "sInfoEmpty" => trans('admin.end_state_empty_blocker'),
            "sInfoFiltered" => "",
            "sInfoPostFix" => "",
        ...
        return $this->builder()
                    ...
                    ->parameters([
                        ...
                        'buttons' => [//'csv', 'excel', 'pdf', 'print', 'reset', 'reload'
                            ...
                            ['className'=>'btn btn-success datatables_btn','text'=>'<i class="fa fa-check" style="margin-right:4px"></i> '.trans('admin.active_all_button'),"action" => "function(){
                                    window.location.href = '".\URL::current()."/active/all';
                            }"
                            ],
