<a href="{{url('dashboard/admin/controll/secretary/'.$id.'/edit')}}"><span class="btn btn-info"><i class="material-icons">edit</i></span></a>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
      	{!!Form::open(['url'=>'dashboard/admin/controll/secretary/'.$id,'method'=>'delete'])!!}
