...
@section('pageTitle')
  {{get_settings()->sitename}} | {{trans('common.add_secratry')}}
@endsection
       ...
       <div class="card">
           <div class="header">
                <h2 style="margin-top: 7px;">
                    <i class="material-icons pull-left" style="margin-top: -4px">person_add</i><span class="pull-left" style="margin-left: 10px"> {{trans('common.add_secratry')}}</span>
                </h2>
                <br>
           </div>
           <div class="body">
