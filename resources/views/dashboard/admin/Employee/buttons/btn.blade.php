<a href="{{url('dashboard/admin/controll/employee/'.$id.'/edit')}}"><span class="btn btn-info"><i class="material-icons">edit</i></span></a>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Delete Emoployee</h4>
      </div>
      <div class="modal-body">
        <p class="alert alert-warning">{{ trans('admin.are_sure_single',['name'=>$name]) }}</p>
      </div>
      <div class="modal-footer">
      	{!!Form::open(['url'=>'dashboard/admin/controll/employee/'.$id,'method'=>'delete'])!!}
