...
@section('pageTitle')
 {{get_settings()->sitename}} | {{trans('common.add_employee')}}
@endsection
       ...
       <div class="card">
           <div class="header">
                <h2 style="margin-top: 7px;">
                    <i class="material-icons pull-left" style="margin-top: -4px">person_add</i><span class="pull-left" style="margin-left: 10px"> {{trans('common.add_employee')}}</span>
                </h2>
                <br>
           </div>
           <div class="body">
                {{Form::open(['novalidate'=>'novalidate','id'=>'form_validation','url' => 'dashboard/admin/controll/employee','method'=>'POST','class'=>'demo-masked-input'])}}
                    <div class="col-md-12">
