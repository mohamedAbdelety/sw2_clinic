...
@section('pageTitle')
 {{get_settings()->sitename}} | {{trans('admin.edit_employee')}}
@endsection
       ...
       <div class="card">
           <div class="header">
                <h2 style="margin-top: 7px;">
                    <i class="material-icons pull-left" style="margin-top: -4px">person_add</i><span class="pull-left" style="margin-left: 10px">{{trans('admin.edit_employee')}}</span>
                </h2>
                <br>
           </div>
           <div class="body">
                {{Form::open(['novalidate'=>'novalidate','id'=>'form_validation','url' => 'dashboard/admin/controll/employee/'.$employee->employeeID,'method'=>'put','class'=>'demo-masked-input'])}}
                    ...
                    <div class="col-md-6">
                            {!! Form::select('gender',['male'=>trans('common.male'),'female'=>trans('common.female')],$employee->gender,['class'=>'form-control show-tick']) !!}
                    </div>
                    <div class="col-md-6">
                        {!! Form::select('weekend',days(),$employee->weekend,['class'=>'form-control show-tick']) !!}
                    </div>
                        {!! Form::submit(trans('common.save_employee'),['class'=>'btn btn-primary']) !!}
