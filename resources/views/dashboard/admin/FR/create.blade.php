...
@section('pageTitle')
 {{get_settings()->sitename}} | {{trans('common.add_fr')}}
@endsection
       ...
       <div class="card">
           <div class="header">
                <h2 style="margin-top: 7px;">
                    <i class="material-icons pull-left" style="margin-top: -4px">person_add</i><span class="pull-left" style="margin-left: 10px">{{trans('common.add_fr')}}</span>
                </h2>
                <br>
           </div>
           <div class="body">
                {{Form::open(['novalidate'=>'novalidate','id'=>'form_validation','url' => 'dashboard/admin/controll/fr','method'=>'POST','class'=>'demo-masked-input'])}}
                    <div class="col-md-12">
                    ...
                    <div class="col-md-6">
                        ...
                        {!! Form::submit(trans('common.save_fr'),['class'=>'btn btn-primary']) !!}
