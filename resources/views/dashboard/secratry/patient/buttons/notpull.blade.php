  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Delete Not Pull Detection</h4>
      </div>
      <div class="modal-body">
        <p class="alert alert-warning">{{ trans('admin.are_sure_delete_notpull') }}</p>
      </div>
      <div class="modal-footer">
      	{!!Form::open(['url'=>'dashboard/secratry/controll/detection/notpull/'.$id,'method'=>'delete'])!!}
