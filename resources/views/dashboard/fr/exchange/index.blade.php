...
@section('pageTitle')
 {{get_settings()->sitename}} | {{trans('common.manage_exchange')}}
@endsection
        ...
        <div class="card">
           <div class="header">
                <h2 style="margin-top: 7px;">
                    <i class="material-icons pull-left" style="margin-top: -4px">money</i><span class="pull-left" style="margin-left: 10px">{{trans('common.manage_exchange')}}</span>
                </h2>
                <br>
           </div>
           <div class="body">
