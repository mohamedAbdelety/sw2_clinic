<a href="{{url('dashboard/fr/controll/exchange/'.$id.'/edit')}}"><span class="btn btn-info"><i class="material-icons">edit</i></span></a>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
      	{!!Form::open(['url'=>'dashboard/fr/controll/exchange/'.$id,'method'=>'delete'])!!}
